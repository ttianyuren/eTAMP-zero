...
def run_symk(
    domain_file="testIO_symk/domain.pddl",
    problem_file="testIO_symk/prob01.pddl",
    plan_file="testIO_symk/found_plans/sas_plan",
    num_plan=11,
):
    ...
    sys.argv = [
        ...
        problem_file,
        "--search",
        "symk-bd(plan_selection=top_k(num_plans={:d}))".format(num_plan),
    ]
...
if __name__ == "__main__":
    ...
    path_output = dir_path + "/sk_plans/sk"
